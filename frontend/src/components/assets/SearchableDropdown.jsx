...
function SearchableDropdown({items, name, value, onChange}) {
  ...
  return (
    <div className={SearchableDropdownCSS.parent}>
        <input type="text" name={name} onChange={(e) => {onFilter(e); onChange(e)}} value={value} onFocus={onFocus} onBlur={onBlur} className={LoginCSS.input}/>
