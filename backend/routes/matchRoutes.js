...
const {getMatch, getMatches, getMatchesByEventName, postMatch, updateMatch, deleteMatch, restoreMatch, getMatchesByEventId} = require('../controllers/matchController')
